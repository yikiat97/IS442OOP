...
function WorkflowsAdmin(){
    ...
    return(
        <Grid sx={{mt:6, textAlign:'left', px:4}}>
            ...
            <Grid container spacing={{ md: 6 }} columns={{xs:12, sm:4,md:3}} sx={{display:"flex", justifyContent:"space-between", alignItems:"center",pt:3}}>
                <Grid item md={2}>
                    <h1>Workflows</h1>
                </Grid>
            ...
            <Grid container spacing={{ md: 12 }} columns={{xs:12, sm:3,md:3}} sx={{display:"flex", justifyContent:"space-between", alignItems:"center",pt:3}}>
                <Grid item md={2}>
                    <h3>Workflows Due</h3>
                </Grid>
