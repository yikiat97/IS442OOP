...
function UserManagement() {
  ...
  const getQuantumRegNum = () => {
    axios
      .get("http://localhost:8080/company/quantumRegNum")
      .then((response) => {
  ...
  const getNumUsers = () => {
    axios
      .get("http://localhost:8080/login/numUsers")
      .then((response) => {
  ...
  return (
    <Grid sx={{ my: 6, textAlign: "left", px: 4 }}>
      ...
      <UserManagementTable props={companies} />
    </Grid>
  );
}
